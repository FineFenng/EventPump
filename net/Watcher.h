...
public:
	...
	ReadableCallback readableCallback() const
	{ return readableCallback_; }

	WritableCallback writableCallback() const
	{ return writableCallback_; }

	bool isReadable()
	{ return static_cast<bool>(events_ &= ev::READ ); }

	bool isWritable()
	{ return static_cast<bool>(events_ &= ev::WRITE); }
